...
home_pose = [ -1.5413e+0;   -4.0609e-2;    +7.2534e-1;  -1.80e+2;         0;         0];
% sending new pose of dummy attached to EE wrt RCM
[~]= vrep.simxSetObjectPosition(ID, h_followed, -1, home_pose(1:3), vrep.simx_opmode_oneshot);
[~]= vrep.simxSetObjectOrientation(ID, h_followed, -1, home_pose(4:6), vrep.simx_opmode_oneshot);
